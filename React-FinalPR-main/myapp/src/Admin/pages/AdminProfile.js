            ...
            <div className="col-xl-4">
              <div className="card">
                <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
                  ...
                  <h2>Shruti Vaghani</h2>
                  <h3>React Developer</h3>
                  <div className="social-links mt-2">
                    <a href="#" className="facebook"><i className="bi bi-facebook" /></a>
                    <NavLink to={`www.linkedin.com/in/shruti-vaghani-8a3321241`} className="instagram"><i className="bi bi-instagram" /></NavLink>
                  ...
                  <div className="tab-content pt-2">
                    <div className="tab-pane fade show active profile-overview" id="profile-overview">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-9 col-md-8">Shruti Vaghani</div>
                      </div>
                      <div className="row">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-9 col-md-8">React Designer</div>
                      </div>
                      <div className="row">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-9 col-md-8">Shrutivaghani2004@gmail.com</div>
                      </div>
                    </div>
                    <div className="tab-pane fade profile-edit pt-3" id="profile-edit">
                      ...
                      <form>
                        ...
                        <div className="row mb-3">
                          ...
                          <div className="col-md-8 col-lg-9">
                            <input name="fullName" type="text" className="form-control" id="fullName" defaultValue="Shruti Vaghani" />
                          </div>
                        </div>
                        <div className="row mb-3">
                        ...
                        <div className="row mb-3">
                          ...
                          <div className="col-md-8 col-lg-9">
                            <input name="job" type="text" className="form-control" id="Job" defaultValue="Web Developer" />
                          </div>
                        </div>
                        <div className="row mb-3">
